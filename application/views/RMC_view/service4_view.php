...
<?php foreach ($seo as $meta) : ?>
    <?php if ($meta->id == 4) : ?>
        <!-- Set the meta title and description dynamically based on the $seo array when id equals 4 -->
...
<body>
    <div class="banner-service-4">
        <!-- Banner background with animation for Service 4 -->
        <div class="banner-back-service-4" data-aos="fade-right" data-aos-duration="2000">
            <h1 class="banner-title">Master <span class="decoration"> Planning</span></h1>
            <br>
    ...
    <div class="container-para">
        <!-- Description of master planning services -->
    ...
    <div class="container-8">
        <div class="row01">
            ...
            <br><br>
            <!-- Button to open collaboration modal -->
